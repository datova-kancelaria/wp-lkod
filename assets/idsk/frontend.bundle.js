(function (global, factory) {
   ...
   * @preserve
   */
  class Textarea extends GOVUKFrontendComponent {
    /**
  ...
  function initAll(config) {
    ...
    const components = [[Accordion, config.accordion], [Button, config.button], [Checkboxes], [ErrorSummary, config.errorSummary], [Header], [NotificationBanner, config.notificationBanner], [Radios], [FileUpload], [Textarea]];

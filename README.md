...
Alternatívne skopírujte priečinok `wp-lkod-main/` do `wp-content/themes/`.
...
1. Zapnite verejnú dostupnosť prístupového bodu LKOD v nastaveniach pluginu (Administrácia → Nastavenia → Lokálny katalóg → Nastavenia lokálneho katalógu → **Prístupový bod katalógu je verejne dostupný - uistite sa, že je označené**)
...
4. Zaregistrujte LKOD na data.slovensko.sk. Ako prístupový bod vyplňte adresu, ktorú ste si poznačili. Viac informácií: https://slovak-egov.atlassian.net/wiki/spaces/opendata/pages/20055786/Ako+m+em+automatizovane+publikova+otvoren+daje+na+data.slovensko.sk
